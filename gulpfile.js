...
gulp.task('sync', function() {
  gulp.watch('craft/templates/assets/scss/**/*.scss',  ['sass']);
  gulp.watch('craft/templates/assets/js/**/*.js',      ['js']);
  gulp.watch('craft/templates/**/*.html',              ['blankTask', browserSync.reload]);
});
...
gulp.task('js', function() {
  return gulp.src('craft/templates/assets/js/**/*.js')
    .pipe(plumber())
...
gulp.task('images', function() {
  return gulp.src('craft/templates/assets/images/**/*')
    .pipe(plumber())
...
gulp.task('fonts', function() {
  return gulp.src(['craft/templates/assets/fonts/**/*'])
